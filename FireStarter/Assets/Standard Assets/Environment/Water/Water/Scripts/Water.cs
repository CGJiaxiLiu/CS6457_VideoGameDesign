    ...
    public class Water : MonoBehaviour
    {
        ...
        public void OnWillRenderObject()
        {
            ...
            if (mode >= WaterMode.Reflective)
            {
				...
				reflectionCamera.cullingMatrix = cam.projectionMatrix * cam.worldToCameraMatrix * reflection;
            ...
            if (mode >= WaterMode.Refractive)
            {
                ...
                //refractionCamera.cullingMatrix = cam.projectionMatrix * cam.worldToCameraMatrix * reflection;
                //refractionCamera.cullingMatrix = m;
